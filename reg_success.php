...
<!DOCTYPE html>
    ...
    <head>
        ...
        <title>Registration Successful</title>    <!-- Bootstrap -->
        <link href="css/bootstrap.min.css" rel="stylesheet">

        <!-- Fonts -->

        <link rel="shortcut icon" href="assets/img/logo/samtl_logo.png" type="image/x-icon"/>
...
.panel-heading {
    color: white;
    background-color: #45010e !important;
}
</style>
                ...
                <div class="panel panel-default" style="margin-top:30px;">
                    <div class="panel-body" style="padding: 100px 10px;">
                        <div class="text-center">
                                ...
                                <a class="btn btn-success" href="register.php">Submit another entry</a>
                        </div>
